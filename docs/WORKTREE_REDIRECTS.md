...
## Claude and Worktrunk Lifecycle Adapters
...
Claude, Worktrunk, and native Git may all invoke setup for the same worktree.
Matching repeated or concurrent requests converge on the same redirect; none
creates a second database or tracker authority.

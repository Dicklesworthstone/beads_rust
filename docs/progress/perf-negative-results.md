...
- **Measurement summary:** Unlimited JSON improved from median/p95 `62.802528/72.785260 ms` to `45.135305/50.091848 ms`, reductions of `28.131388%/31.178582%`; the 100,000-resample bootstrap candidate/baseline median-ratio 95% CI was `0.704796..0.734642`. The unaffected text control changed by `+1.644264%` median and `-1.683060%` p95, within the `5%` regression guardrail. `--limit 10 --json`, where hydration follows truncation, improved median/p95 by `27.343606%/24.988808%`. JSON, TOON, and text were byte-identical with SHA-256 values `8cf9a9e8ce6d905464f74972f7bfc696a83de9d001fb827e1b70d9c5a7bc6449`, `cd15b4b3982f3ccf9652f93dd7c1a0b90bb4c802e7d1b1465f15f4698ebe3111`, and `e4abe3873d2118de95c6469265d62465e19ab64d61f93395e66e392b1440955f`; all smoke stderr streams were empty and fixture hashes were unchanged.
